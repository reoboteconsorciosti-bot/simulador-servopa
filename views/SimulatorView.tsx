        ...
        <form onSubmit={handleSimulate}>
          ...
          <Card title="Configuração do Lance" className="mb-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <Select label="Como usar o Lance?" name="diluirLance" value={inputs.diluirLance} onChange={handleInputChange} options={[{ value: 1, label: 'Reduzir Valor da Parcela (Diluir)' }, { value: 2, label: 'LUDC' }, { value: 3, label: 'Reduzir Prazo (Abater)' }]} tooltip="Define o que acontece com o valor do lance após a contemplação. 'Reduzir Valor' mantém o prazo e diminui a parcela. 'Reduzir Prazo' mantém a parcela e diminui o número de meses." />
