        ...
        <form onSubmit={handleSimulate}>
          ...
          <Card title="Parâmetros do Crédito" className="mb-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <Select label="Seguro Prestamista" name="seguroPrestamista" value={inputs.seguroPrestamista} onChange={handleInputChange} options={[{ value: 1, label: 'Seguro de Vida' }, { value: 2, label: 'Vida + Quebra de Garantia' }, { value: 3, label: 'Sem Seguro' }]} tooltip="Garante a quitação do saldo devedor em caso de imprevistos. O 'Vida + Quebra de Garantia' é comum para automóveis." />
